...
This is a pragmatic troubleshooting checklist for operators running Certisent on shared hosting or a VPS.
...
- `php /path/to/certisent/scripts/worker.php --due` every 5–15 minutes.
