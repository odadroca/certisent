...
- Sentryficate-defined certificate/public-key pinning (not HPKP preload): per-monitor `monitor_settings.pin_mode` (`off|observe|enforce`, default `off`) plus `monitor_settings.pin_spki_sha256` (base64 sha256 of SPKI).
