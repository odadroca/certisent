...
render_header('Delete monitor', $user);
?>
<div class="bg-white text-black rounded-2xl p-6 shadow max-w-xl">
  <h1 class="text-xl font-semibold mb-4">Delete monitor</h1>
  <div class="text-sm text-gray-700 mb-4">
    This stops monitoring: <span class="font-mono"><?php echo h($m['url']); ?></span>
  </div>
  <form method="post" class="flex gap-3 items-center">
    <?php echo csrf_field(); ?>
    <button class="bg-red-700 text-white px-4 py-2 rounded">Delete</button>
    <a class="text-green-700 hover:underline" href="dashboard.php">Cancel</a>
  </form>
</div>
<?php render_footer(); ?>
